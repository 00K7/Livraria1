...
public class gps extends AppCompatActivity implements SensorEventListener, FetchAddressTask.OnTaskCompleted {
    ...
    Sensor light;
    RelativeLayout tela8;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gps);

        tela8 = (RelativeLayout) findViewById(R.id.tela8);
        ...
        listener = new SensorEventListener() {
            ...
            public void onSensorChanged(SensorEvent event) {
                ...
                tela8.setBackgroundColor(Color.rgb(grayShade, grayShade, grayShade));
            }
        };

        sm.registerListener(listener, light, SensorManager.SENSOR_DELAY_FASTEST);

        mLocationButton = (Button) findViewById(R.id.btnfind);
        ...
        mLocationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                if (mTrackingLocation) {
                    new FetchAddressTask(gps.this, gps.this)
        ...
        sensorManager.registerListener((SensorEventListener) this, acelerometro, SensorManager.SENSOR_DELAY_NORMAL);
        ...
        Button btnVoltar8 = (Button) findViewById(R.id.btnVoltar8);
